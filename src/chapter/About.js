        ...
        return (
                <section id="About">
                    ...
                    <div className="about-profile">
                        ...
                        <div className="about-block">
                            <div className="about-skills">
                                ...
                                <span style={ { bottom: "40%", left: "50%" } }>Vue Server Renderer</span>
                                ...
                                <span style={ { bottom: "30%", left: "70%" } }>SVG</span>
                    ...
                    <div className="about-bio">
                        <p className="about-block">Since the first time I created my own website when I was 10 years old. I took a fancy to do creation of all about digital content. Such as animation, game and tool software. It defined my choice of my career in the future. Most of time, I was able to learn new skills of programming by my self. However, I was concerned about the design and the thinking of the users. The point was the key I decided to major in media design. Because of that, I am good at both of development and user experience.</p>
                        <p className="about-block">Recently, my colleague and I designed a service in a hackathon. After that, we rebuilt the idea to a new chat bot -- noper. It helped people who usually have business conversation at messaging tools when they were working. To manage and notify progress of the tasks with team members. We released the service for public for few monthes. Although there were many users registered our service, it was hard to be main income for us. Unfortunately, we decided to close the project.</p>
                        <p className="about-block">This years, I did full time jobs of front end developer and freelace jobs of full stack developer for few times. That is interesting to have chance to create different kind of products. I like to work with people cooperatively. Also I am excited to face challenge and solve them. Additionally, it is interesting to research new technology to me. With my skills of front end development and knowledge of back end. Hoping to have the opportunity to make more great works with great people. </p>
                    </div>
                </section>
            );
