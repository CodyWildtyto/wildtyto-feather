                ...
                <section id="Showhi" style={ { backgroundImage: `url(${ showhiPicture1 })`, backgroundPositionY: this.state.offsetY } }>
                    <div className="work-container">
                        ...
                        <div className="work-explain">
                            <p>There was a social network for students who would like to study abroad and school recruiters who help students applying the university.</p>
                            <p>School pages could be managed by the school recruiters. Students were able to contact and apply the university school directly. Also it was easy to send documents to each other in messaging system.</p>
